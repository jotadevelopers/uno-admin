    ...
    <div class="min-h-screen flex-row justify-center items-center p-2">
        <UCard class="max-w-xl mx-auto shadow-lg">
            ...
            <UForm class="space-y-4 mt-4" :state="formData" :schema @submit="onSubmit">
                ...
                <UButton @click="notImplemented" color="gray" label="Sign in with Google" icon="i-simple-icons-github"
                    block />
                <UButton @click="notImplemented" color="gray" label="Sign in with Facebook" icon="i-simple-icons-google"
                    block />
